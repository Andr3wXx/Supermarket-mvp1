    ...
    internal class PayModeRepository : BaseRepository, IPayModeRepository
    {
        ...
        public void Add(PayModeModel payModeModel)
        {
            ...
            using (var command = new SqlCommand())
            {
                ...
                command.CommandText = "INSER INTO PayMode VALUES (@name, @observation)";
        ...
        public void Delete(int id)
        {
            ...
            using (var command = new SqlCommand())
            {
                connection.Open();
                command.Connection = connection;
                command.CommandText = "DELETE FRROM PayMode WHERE Pay_Mode_Id = @id";
        ...
        {
            var payModelList = new List<PayModeModel>();
            using (var connection = new SqlConnection(connectionString))
            using (var command = new SqlCommand())
            {
                connection.Open();
